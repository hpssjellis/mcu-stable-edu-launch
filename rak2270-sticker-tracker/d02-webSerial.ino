...
/*
  ...
  if ( (millis() - myStart ) >= myDelay) {       
   ...
   Serial.println( "2 second to click the clear button" );
   Serial.println( "Then move the object" );
   Serial.println( "1 seconds to clean and keep the data" );
   delay(2000); // short delay to get ready to do something
